...
console.log(nosex+"o "+nosey);
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("click the button to play game ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
...
/*=====  etc end of thinking and calculating  ======*/
